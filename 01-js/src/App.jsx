...
function App() {
  ...
  return (
    <div className="cont-app">
      ...
      <hr />
      <button onClick={easteregg}>Segredo</button>
      {mostrar && (
  <img 
    className="bg-secret" 
    src="https://static.wikia.nocookie.net/bluelockfanon/images/2/2e/Bastard_Munchen.png/revision/latest?cb=20250108182021" 
    alt="" 
  />
)}
    </div>
